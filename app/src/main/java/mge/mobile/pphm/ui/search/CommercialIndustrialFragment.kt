        ...
        activity?.let {
         ...
         /*   binding.industrialCommercialSearchQuestion4Answer2.setOnCheckedChangeListener { _, checkedId ->
            ...
            binding.industrialCommercialSearchQuestion5Answer11.setOnClickListener(View.OnClickListener {
                if(binding.industrialCommercialSearchQuestion5Answer11.isChecked){
            ...
            binding.industrialCommercialSearchQuestion5Answer12.setOnClickListener(View.OnClickListener {
                if(binding.industrialCommercialSearchQuestion5Answer12.isChecked){
            ...
            binding.industrialCommercialSearchQuestion5Answer13.setOnClickListener(View.OnClickListener {
                if(binding.industrialCommercialSearchQuestion5Answer13.isChecked){
            ...
            binding.industrialCommercialSearchQuestion5Answer14.setOnClickListener(View.OnClickListener {
                if(binding.industrialCommercialSearchQuestion5Answer14.isChecked){
